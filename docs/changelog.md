...
This entry describes the documentation refresh.

- Added self-contained code examples, integration guidance and community contribution guidance.
...
The mining incident is summarized in [claims](claims.md) and [validation](validation-security.md). Investigation measurements describe a dated check, not continuously current totals.
